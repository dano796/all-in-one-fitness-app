...
const ModulesPage: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-16 bg-[#1C1C1E] text-white">
      <h1 className="text-4xl font-bold mb-8 text-center text-yellow-400">Nuestros Módulos</h1>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <ModuleCard
          icon={<Utensils className="w-8 h-8 text-[#FFCC00]" />}
        ...
        />
        <ModuleCard
          icon={<Dumbbell className="w-8 h-8 text-[#FFCC00]" />}
        ...
        />
        <ModuleCard
          icon={<Activity className="w-8 h-8 text-[#FFCC00]" />}
        ...
        />
        <ModuleCard
          icon={<Droplets className="w-8 h-8 text-[#FFCC00]" />}
        ...
        />
        <ModuleCard
          icon={<Calculator className="w-8 h-8 text-[#FFCC00]" />}
        ...
        />
        <ModuleCard
          icon={<Camera className="w-8 h-8 text-[#FFCC00]" />}
