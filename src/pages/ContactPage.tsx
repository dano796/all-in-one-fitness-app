  ...
  return (
    <div className="container mx-auto px-4 py-16 bg-[#111827] text-white">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-[#1E293B] rounded-xl p-8 shadow-md">
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full px-4 py-2 border border-gray-500 rounded-lg bg-[#111827] text-white focus:ring-2 focus:ring-[#FF6B35] focus:border-transparent"
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 bg-[#FF9500] text-white font-semibold rounded-lg hover:bg-[#FF9500] transition duration-300"
            >
              Enviar Mensaje
            </button>
          </form>
