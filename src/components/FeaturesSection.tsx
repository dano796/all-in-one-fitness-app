  ...
  return (
    <section className="bg-[#1C1C1E] py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl pt-10 pb-5 font-bold text-center mb-12 text-[#FF3B30]">
          ¿Por qué usar All In One Fitness App?
        </h2>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-[#1C1C1E] text-white rounded-xl p-6 shadow-lg">
              <div className="bg-[#FF9500] rounded-lg w-16 h-16 flex items-center justify-center mb-4">
                {feature.icon}
              </div>
